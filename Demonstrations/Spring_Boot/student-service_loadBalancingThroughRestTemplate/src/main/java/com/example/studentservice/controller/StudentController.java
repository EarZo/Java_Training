...
public class StudentController {
	...
	public Student getStudent(@PathVariable Integer studentId) {
		...
		student.setStudentAllocations(studentService.getStudentAllocations(studentId));
	...
	public List<Student> getAllStudents() {
		...
		for(Student student : studentList) {
			student.setStudentAllocations(studentService.getStudentAllocations(student.getStudentId()));
		}
