...
public class StudentServiceImpl implements StudentService {
	...
	public Allocation[] getStudentAllocations(Integer studentId){
		...
		ResponseEntity<Allocation[]> allocationsResponse = restTemplate.exchange("http://allocationService/services/allocations/" + studentId, HttpMethod.GET, allocationsRequest, Allocation[].class);
