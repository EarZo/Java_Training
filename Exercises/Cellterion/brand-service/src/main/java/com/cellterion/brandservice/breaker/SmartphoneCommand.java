...
public class SmartphoneCommand extends HystrixCommand<Smartphone[]> {
    ...
    protected Smartphone[] run() throws Exception {
        ...
        ResponseEntity<Smartphone[]> smartphonesResponse = smartphonesResponse = restTemplate.exchange("http://smartphoneService/services/smartphone/all/brand/" + brand.getBrandName(), HttpMethod.GET, smartphonesRequest, Smartphone[].class);
